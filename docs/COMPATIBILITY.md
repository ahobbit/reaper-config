...
Pinned versions: REAPER 7.79, Reapertips Theme 1.93b, SWS 2.14.0.7, ReaPack 1.2.6.
...
| macOS Dark Mode | Mac only | Retained setting; depends on macOS system appearance. |
